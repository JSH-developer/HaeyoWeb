...
%>
<tr><td><a class="blike" ><img src='../images/smile.png' class='sicon' width='25' height='25'></a> <%=bdao.countBoardLike("jj", idx) %>  <a class="bunlike" ><img src='../images/sad.png' class='sicon' width='25' height='25'></a> <%=bdao.countBoardUnlike("jj", idx) %></td></tr>
</table>

<!-- 버튼 모음 -->
<button onclick="location.href='jjBoard.jsp?page=<%=bpage%>'">목록가기</button>  
