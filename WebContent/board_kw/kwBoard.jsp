...
<%
	out.print(bdao.categoryBoard("kw",1,"공지"));
	if(bcategory!=null){
...
<%
	...
	if(bpage<10){ // 10이상부터 형식이 바뀜
		...
		if(bcategory != null){
			out.println("<a href='kwBoard.jsp?page="+(bpage+5)+"&category="+bcategory+"'> 다음 </a>");
		}else{
			out.println("<a href='kwBoard.jsp?page="+(bpage+5)+"'> 다음 </a>");
		}
