...
<%
	...
	String file =fdao.getFileFromIdx("dat", idx);
...
$(function(){
	...
	$("a.download").on("click",function(){
		var is_down = confirm("다운로드 받으시겠습니까?");
		if(!is_down){
	...
	//현재 리스트 표시
	$("#tr<%=idx%>").css("background-color","#e6e6e6");
...
<!-- 버튼 모음 -->
<button onclick="location.href='datBoard.jsp?page=<%=bpage%>'">목록가기</button>
<%  if( fdao.getIdFromIdx("dat", idx).equals(id) ){%>
	<button onclick="location.href='updateForm.jsp?page=<%=bpage%>&idx=<%=idx%>'">코멘트수정</button>
